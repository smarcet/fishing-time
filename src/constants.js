...
const BARRACUDA_DRIFT_SPEED      = 5.5;  // px/tick
const SQUID_DRIFT_SPEED          = 5.6;  // px/tick - ties AnglerFlish for fastest swim speed
...
const HOOK_STATUS_CAPTURE_LAUNCH   = 'CAPTURE_LAUNCH';

// Capture launch timing - TUNE
const CAPTURE_LAUNCH_DURATION_MS = 400; // ms - total time for the capture-launch arc

const CAPTURE_POOF_COLOR        = 'rgba(255,210,40,1)';  // warm gold starburst ray color
const CAPTURE_LAUNCH_GLOW_COLOR = 'rgba(255,160,0,1)';   // vivid orange silhouette glow
...
const ENEMY_TYPE_ANGLER_FLISH      = 'angler_flish';
const ENEMY_TYPE_BARRACUDA         = 'barracuda';
const ENEMY_TYPE_SQUID             = 'squid';
...
const FISH_CLASS_ANGLER_FLISH     = 'AnglerFlish';
const FISH_CLASS_BARRACUDA        = 'Barracuda';
const FISH_CLASS_SQUID            = 'Squid';
...
const FISH_SCHOOL_SIZE_MIN        = 2;
const FISH_SCHOOL_SIZE_MAX        = 3;
...
// FishSpawner reads id/lanes/rarity/score/strength/escapeRate/speed*/spawnWeight/spawnFrequency/trafficOffsetY.
const FISH_DEFINITIONS = [
  ...
  {
    id: ENEMY_TYPE_BARRACUDA,
    className: FISH_CLASS_BARRACUDA,
    domId: 'barracuda_sprite',
    displayH: 90,    displayW: 360,
    frameH: 128,     frameW: 512,
    maxFrameX: 4,    maxFrameY: 1,
    dieFrameX: 0,    dieFrameY: 1,
    rarity: FISH_RARITY_RARE,
    ...
    escapeRate: 2,
    speedMin: 3.5,
    speedMax: BARRACUDA_DRIFT_SPEED,
    spawnWeight: 2,
    spawnFrequency: 390,
    captureRotation: -15,
    captureOffsetX: 0,
  ...
  },
  {
    ...
    domId: 'squid_sprite',
    displayH: 58,    displayW: 240,
    frameH: 222,     frameW: 910,
...
const GAMEPLAY_PROFILE_DESKTOP = Object.freeze({
  ...
  guaranteedSpeciesIntervals: Object.freeze({ [ENEMY_TYPE_LOBSTER]: 3600, [ENEMY_TYPE_CHEST_WITH_JEWELS]: 1800, [ENEMY_TYPE_ANGLER_FLISH]: 1800 }),
  guaranteedSpeciesInitialOffsets: Object.freeze({ [ENEMY_TYPE_LOBSTER]: 1800, [ENEMY_TYPE_CHEST_WITH_JEWELS]: 900, [ENEMY_TYPE_ANGLER_FLISH]: 1800 }),
});
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    ...
    SWORDFISH_DRIFT_SPEED, BARRACUDA_DRIFT_SPEED, SQUID_DRIFT_SPEED, TUNA_DRIFT_SPEED, CLOWN_FISH_DRIFT_SPEED,
    ...
    ENEMY_TYPE_BUTTERFLY_FISH, ENEMY_TYPE_LION_FISH, ENEMY_TYPE_HAMMERHEAD_SHARK, ENEMY_TYPE_SWORDFISH, ENEMY_TYPE_TUNA, ENEMY_TYPE_CLOWN_FISH, ENEMY_TYPE_DISCARDED_BOTTLE, ENEMY_TYPE_OCTOPUS, ENEMY_TYPE_CRAB, ENEMY_TYPE_SHARK, ENEMY_TYPE_RED_APPLE, ENEMY_TYPE_JELLY_FISH, ENEMY_TYPE_WHEEL, ENEMY_TYPE_PUFFER_FISH, ENEMY_TYPE_SHOE, ENEMY_TYPE_FISH_BONE, ENEMY_TYPE_CHEST_WITH_JEWELS, ENEMY_TYPE_CLOCK, ENEMY_TYPE_LOBSTER, ENEMY_TYPE_ANGLER_FLISH, ENEMY_TYPE_BARRACUDA, ENEMY_TYPE_SQUID,
    ...
    FISH_CLASS_WHEEL, FISH_CLASS_PUFFER_FISH, FISH_CLASS_SHOE, FISH_CLASS_FISH_BONE, FISH_CLASS_CHEST_WITH_JEWELS, FISH_CLASS_CLOCK, FISH_CLASS_LOBSTER, FISH_CLASS_ANGLER_FLISH, FISH_CLASS_BARRACUDA, FISH_CLASS_SQUID,
