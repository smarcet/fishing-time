...
// Capture launch sparkle colors - easy to change here
const CAPTURE_SPARKLE_COLORS    = ['rgba(255,60,60,1)', 'rgba(255,140,100,1)'];
const CAPTURE_LAUNCH_GLOW_COLOR = 'rgba(255,80,80,0.9)';
